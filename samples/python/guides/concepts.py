...
display(type(client_string))  # str
...
display(type(server_string))  # ee.ee_string.String
display(
...
display(server_string)  # I am not a String
# [END earthengine__concepts__print_string]

# [START earthengine__concepts__to_string]
print(server_string)  # ee.String("I am not a String!")
...
display(strings)  # I am not a String!  Am I?
...
display('Should be False:', server_boolean)  # True!
...
display('Should be False:', server_conditional)  # False!
